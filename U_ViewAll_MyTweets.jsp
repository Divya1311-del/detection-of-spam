	...
	while ( rs.next() )
	{
		...
		%>
				...
				<tr>
			      ...
			      <td  width="102" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Comments</div></td>
				</tr>
					<%}%>
				<tr>
						
	   	<td width="109" bgcolor="#FFFF00"><input  name="image" type="image" style="width:100px; height:100px;" src="profile_pic.jsp?id=<%=i%>&type=<%="tweet"%>"/></td>
			  <td  width="97" height="110" align="center" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style10"><%out.println(s2);%></div></td>	
			  <td  width="206" height="110" align="center" valign="middle" bgcolor="#FFFF00"><div align="center" class="style10"><%out.println(s4);%></div></td>
			  <td  width="126" align="center" valign="middle" bgcolor="#FFFF00"><div align="center" class="style10"><%out.println(s5);%></div></td>
			  <td  width="102" height="110" align="center" valign="middle"><div align="center"><a href="U_View_AllComments.jsp?name=<%=s2%>&id=<%=i%>">View Comments</a></div></td>
		</tr>
