...
<div class="main style2">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h2 align="center" class="style5 style10">Detection of Social Network Spam Based on Improved Extreme Learning Machine</h2>
      </div>
...
<%@ include file="connect.jsp" %>
					...
					<tr bgcolor="#FFFFFF">
						...
						<td  width="100" height="40"align="center" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
							<a href="U_FriendProfile.jsp?type1=<%=rt%>" class="style14">more info..&nbsp;</a></td>
						<%
						//application.setAttribute("name",rt);
						}
						else 
						{%>	
						<td  width="100" height="40" align="center" valign="middle" bgcolor="#FFFFFF"><span class="style13">&nbsp;&nbsp;
				        <%out.println(rf);%>
					  </span></td>
						<td  width="100" height="40"align="center" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
							<a href="U_FriendProfile.jsp?type1=<%=rf%>" class="style14">more info..&nbsp;</a></td>
