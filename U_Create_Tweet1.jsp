  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    ...
	    <p class="style6">Tweet Created and Published Successfully.... </p>
	    <p>&nbsp;</p>
	    <p>&nbsp;</p>
...
<%
					...
					try {
						...
						PreparedStatement ps=connection.prepareStatement("insert into tweets(user,tname,image,description,date,rank) values(?,?,?,?,?,?)");
			...
			%>
			<p><a href="U_Create_Tweet.jsp">Back</a>         <a href="U_Main.jsp">Home</a> </p>
