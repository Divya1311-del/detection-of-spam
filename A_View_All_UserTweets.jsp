...
<div class="main style2">
  ...
  <div class="content">
	...
	while ( rs.next() )
	{
	    ...
	    <td  width="108" height="110" align="center" valign="middle" style="color:#000000;"><div align="center" class="style9"><a href="A_User_Profile.jsp?type1=<%=s7%>"><%=s7%></a></div></td>	
