  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    ...
	    <p>&nbsp;</p>
	    <p>&nbsp;</p>
	    <p class="style6">VIEW ALL COMMENTS ..,. </p>
	    <p>&nbsp;</p>
	...
	while ( rs.next() )
	{
		...
		%>
				...
				<td  width="102" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style8">Tweet Image</div></td>
				  ...
				  <td  width="244" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style8">Comment</div></td>
		...
		<td width="109"><input  name="image" type="image" style="width:100px; height:100px;" src="profile_pic.jsp?id=<%=id%>&type=<%="tweet"%>"/></td>	
	   	      <td  width="102" height="110" align="center" valign="middle" style="color:#000000;"><div align="center"><%out.println(s2);%></div></td>	
			  <td  width="124" height="110" align="center" valign="middle"><div align="center"><%out.println(s1);%></div></td>
			  <td  width="244" align="center" valign="middle"><div align="center"><%out.println(s3);%></div></td>
			  <td  width="170" height="110" align="center" valign="middle"><div align="center"><%out.print(s4);%></div></td>
		</tr>
